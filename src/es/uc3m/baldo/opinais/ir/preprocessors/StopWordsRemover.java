 ...
 * many words (e.g. determinants and prepositions) are meaningless.</p>
 * 
...
public class StopWordsRemover implements Preprocessor<String> {
	...
	private static final String[] stopWords = 
		{"a","able","about","above","abst","accordance","according","accordingly",
		 ...
		 "million","miss","ml","more","moreover","most","mostly","mr","mrs","much","mug","must",
		 ...
		 "until","unto","up","upon","ups","us","use","used","useful","usefully","usefulness","uses",
		 "using","usually","v","value","various","'ve","very","via","viz","vol","vols","vs","w","want",
		 "wants","was","wasn't","way","we","wed","welcome","we'll","went","were","weren't","we've","what",
		 "whatever","what'll","whats","when","whence","whenever","where","whereafter","whereas","whereby",
		 ...
		 "within","without","won't","words","world","would","wouldn't","www","x","y","yes","yet","you",
		 "youd","you'll","your","youre","yours","yourself","yourselves","you've","z","zero"};
	
	/*
	 * Stores all the stop-words in a set.
	 * This field exists for efficiency purposes: it is much
	 * more efficient to check whether a word is contained in
	 * a set rather than in an array.
	 */
	private Set<String> stopWordsSet;
	
	/**
	 * <p>Creates a new stop-words remover.</p>
	 */
	...
	public String process (String text) {
		...
		for (String word : words) {
			// Checks whether the word is an stop word. If that is not the case,
			// it is appended to the string to be returned.
